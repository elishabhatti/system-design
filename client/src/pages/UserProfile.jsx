...
export default function UserProfile() {
  ...
  return (
    <div className="min-h-screen text-zinc-100 pb-16 selection:bg-violet-500 selection:text-white">
      <div className="h-44 w-full bg-linear-to-r from-[#26233A] via-[#1F1D2C] to-[#2A2740] border-b border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 -mt-12 relative z-10 pb-8 border-b border-white/10">
          <div className="w-24 h-24 rounded-2xl bg-linear-to-br from-violet-600 to-indigo-700 border-4 border-[#1F1D2C] flex items-center justify-center text-2xl font-bold shadow-2xl shadow-violet-500/20 text-white shrink-0">
            {initial}
          </div>
          ...
          <div className="text-center md:text-left pt-2 flex-1">
            <div className="flex flex-col md:flex-row md:items-center gap-2">
              ...
              <span className="bg-[#26233A] border border-white/10 text-zinc-400 text-[10px] font-semibold px-2.5 py-0.5 rounded-full w-fit mx-auto md:mx-0">
                Pro Creator
              </span>
            </div>
            ...
            <p className="text-xs text-zinc-400 mt-1 flex items-center justify-center md:justify-start gap-2">
              ...
              <span>•</span>
              <span className="text-zinc-300 font-medium flex items-center gap-1"><Users className="w-3 h-3 text-violet-400" /> 1.4K subscribers</span>
            </p>
          ...
          <div className="flex items-center gap-3 pt-4 md:pt-2">
            <button
              ...
              className="flex items-center gap-2 bg-linear-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white px-4 py-2 rounded-xl text-xs font-semibold shadow-lg shadow-violet-500/20 transition duration-300 cursor-pointer"
            >
              <Sparkles className="w-3.5 h-3.5" /> Customize Channel
            </button>
            <button className="p-2 rounded-xl bg-[#26233A] border border-white/10 text-zinc-400 hover:text-zinc-200 hover:border-white/20 transition cursor-pointer">
        ...
        <div className="flex items-center gap-6 pt-4 border-b border-white/10 mb-6 text-xs font-semibold">
          <button
            ...
            className={`pb-3 border-b-2 flex items-center gap-2 cursor-pointer transition ${
              activeTab === "videos" ? "border-violet-500 text-violet-400" : "border-transparent text-zinc-400 hover:text-zinc-200"
            }`}
          >
          ...
          <button
            ...
            className={`pb-3 border-b-2 cursor-pointer transition ${
              activeTab === "analytics" ? "border-violet-500 text-violet-400" : "border-transparent text-zinc-400 hover:text-zinc-200"
            }`}
          >
            Analytics
          </button>
          <button
            ...
            className={`pb-3 border-b-2 cursor-pointer transition ${
              activeTab === "playlists" ? "border-violet-500 text-violet-400" : "border-transparent text-zinc-400 hover:text-zinc-200"
            }`}
          >
            Playlists
          </button>
