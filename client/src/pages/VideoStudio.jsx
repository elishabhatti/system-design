  ...
  if (loadingVideos) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[75vh]">
        ...
        <p className="text-xs text-zinc-500 mt-3 font-mono">Loading player...</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-full mx-auto px-4 lg:px-8 py-6 text-zinc-100 grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div className="lg:col-span-8 xl:col-span-9 flex flex-col gap-4">
        ...
        <div className="w-full aspect-video bg-black rounded-2xl overflow-hidden border border-zinc-800 shadow-2xl relative">
          <video 
            key={currentVideo.id}
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-zinc-800/80">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="ml-3 bg-white text-zinc-950 font-semibold text-xs px-4 py-2 rounded-full hover:bg-zinc-200 transition">
              Subscribe
            </button>
          </div>
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center bg-[#27272a] rounded-full overflow-hidden border border-zinc-700/50">
              <button className="flex items-center gap-1.5 px-3.5 py-1.5 text-xs font-medium hover:bg-[#3f3f46] transition border-r border-zinc-700/50">
                <ThumbsUp className="w-3.5 h-3.5" />
                <span>28K</span>
              </button>
              <button className="px-3.5 py-1.5 text-xs font-medium hover:bg-[#3f3f46] transition">
                <span className="rotate-180 inline-block"><ThumbsUp className="w-3.5 h-3.5" /></span>
              </button>
            </div>

            <button className="flex items-center gap-1.5 bg-[#27272a] hover:bg-[#3f3f46] px-3.5 py-1.5 rounded-full text-xs font-medium border border-zinc-700/50 transition">
        ...
        <div className="bg-[#1f1f23] border border-zinc-800/80 rounded-xl p-4 text-xs text-zinc-300 leading-relaxed">
      ...
      <div className="lg:col-span-4 xl:col-span-3 flex flex-col gap-3">
        ...
        {/* Playlist Header Box */}
        <div className="bg-[#18181b] border border-zinc-800/80 rounded-xl p-3.5 flex items-center justify-between shadow-md">
          <div>
              ...
              <div 
                ...
                className={`group flex items-center gap-3 p-2 rounded-xl cursor-pointer transition border ${
                  isSelected 
                    ...
                    : 'bg-transparent border-transparent hover:bg-[#18181b]'
                }`}
              >
                {/* Index / Thumbnail */}
                ...
                <div className="flex flex-col overflow-hidden w-full">
                  ...
                  <h4 className={`font-semibold text-xs truncate ${isSelected ? 'text-indigo-400 font-bold' : 'text-zinc-200 group-hover:text-white'}`}>
                    {vid.title}
                  </h4>
